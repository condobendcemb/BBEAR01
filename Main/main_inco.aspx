<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main_inco.aspx.cs" Inherits="BBEAR01.main_inco" %>
                    ...
                    <div class="d-flex justify-content-start flex-wrap gap-2">
                        <div>
                            ...
                            <div id="ddl_roomid" runat="server">
                                ...
                                <asp:DropDownList ID="ddlIncomeId" runat="server" CssClass="form-control" AutoPostBack="true" Width="210px"
                                    OnSelectedIndexChanged="ddlIncomeId_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>

                            <div id="newIncomeDiv" runat="server" visible="false" class="">
                                <label>New Income ID</label>
                                <div class="input-group">
                                    <asp:TextBox ID="txtNewIncomeId" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                        </div>
